...
class RechnrUrlInsert extends Migration {
	...
	public function up()
	{
		...
		DB::table('rechnr_url')->insert(array(
			"id" 			=>  '7',
			"url"			=>	'/carbon_footprint-calculate',
		...
		DB::table('rechnr_url')->insert(array(
			...
			"page_id"		=>  '64',
                ...
                DB::table('rechnr_url')->insert(array(
                        "id"                    =>  '66',
                        "url"                   =>      '/capital-update',
                        "memo"                  =>      'Capital Update Page in English',
                        "as"                    =>      'capital_update',
                        "domain_id"             =>  '1',
                        "page_id"               =>  '66',
                        ));
                ...
                DB::table('rechnr_url')->insert(array(
                        "id"                    =>  '67',
                        "url"                   =>      '/admin-capital',
                        "memo"                  =>      'Admin Capital Page in English',
                        "as"                    =>      'admin_capital',
                        "domain_id"             =>  '1',
                        "page_id"               =>  '67',
                        ));
                ...
                DB::table('rechnr_url')->insert(array(
                        "id"                    =>  '68',
                        "url"                   =>      '/admin-capital-update',
                        "memo"                  =>      'Admin Capital Update Page in English',
                        "as"                    =>      'admin_capital_update',
                        "domain_id"             =>  '1',
                        "page_id"               =>  '68',
                        ));
